...
|----------|-------------|-------------|--------|
| 💼 [Portafolio Web](https://github.com/dienton82/portafolio-ya-) | Portafolio personal optimizado con Next.js y Tailwind CSS, despliegue en Vercel, animaciones con Framer Motion. | Next.js, TypeScript, TailwindCSS, Vercel | 🌐 [Ver sitio](https://portafolio-ya.vercel.app) |
...
| 📄 [Sistema de Facturación PHP](https://github.com/dienton82/facturacion-php) | Gestión de usuarios, cursos, facturación y PDF con autenticación. Ideal para pequeñas empresas. | PHP, MySQL, HTML, CSS | 🌐 [Ver demo](https://github.com/dienton82/facturacion-web) |
